 ...
 <nav id="sideNav">
    ...
    <section id="features">
        <div class="feature-row">
            ...
            <div class="feature-col">
                <img src="images/history.png"><h4></h4>
    ...
    <footer>
        ...
        <div class="follow">
          ...
          <div class="social">
            ...
            <a href="https://www.linkedin.com/in/shipra-rani-9b4858194/" class="linkedin">
        ...
        <p class="text-copy">
          Copyright &copy; 2021 Made by <b>Shipra Rani</b> <br> For the Project of  <b>The Sparks Foundation</b>
        </p>
    </footer>
    <script>
